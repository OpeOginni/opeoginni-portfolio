  ...
  return (
    ...
    >
      <div>
        ...
        <p className="text-center text-neutral-600 dark:text-neutral-400 mb-6 md:mb-8 max-w-2xl mx-auto text-sm md:text-base">
          Here are some of the projects I&apos;ve worked on, showcasing various
