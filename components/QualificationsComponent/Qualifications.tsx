      ...
      <div className="h-max">
        <div className="grid grid-cols-1 gap-8 md:gap-10 lg:grid-cols-2 lg:gap-8">
          <div>
            <div className="w-full text-center">
              <div className="pb-6 md:pb-9">
                ...
                <div className="w-16 h-px bg-neutral-300 dark:bg-neutral-700 mx-auto mt-3"></div>
              </div>
                      ...
                      return (
                        <div key={educationQualification.qualification}>
                          ...
                          {index < myEducationQualificaions.length - 1 && (
                            <div className="w-12 h-px bg-neutral-200 dark:bg-neutral-800 mx-auto mt-6"></div>
                          )}
                        </div>
                      );
                    }
          ...
          <div className="lg:hidden">
            <div className="w-24 h-px bg-neutral-400 dark:bg-neutral-600 mx-auto"></div>
          </div>
